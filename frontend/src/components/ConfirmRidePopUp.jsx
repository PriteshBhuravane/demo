...
const ConfirmRidePopUp = (props) => {
  ...
  return (
    <div>
      ...
      <h3 className="text-xl font-semibold mb-5 mt-10">
        ...
        <div className=" w-full ">
          ...
          >
            <input
              ...
              className="bg-[#eee] px-6 py-3 font-mono text-lg rounded-lg w-full mt-3 focus:outline-none focus:ring-2 focus:ring-blue-400"
            />
            <Link
              to="/captain-riding"
              className=" w-full bg-green-600 flex justify-center font-semibold text-white p-2 rounded-lg mt-5"
            >
              Confirm
            </Link>
            <button
              onClick={() => {
                props.setConfirmRidePopupPanel(false);
                props.setRidePopupPanel(false); // Ensure the ride popup panel stays closed
              }}
              className=" w-full bg-red-600 font-semibold text-white p-2 rounded-lg mt-3"
            >
              Cancel
            </button>
          </form>
